...
description: Platform blockchain infrastructure and wallet options
---

# 2. Platform Infrastructure & Access Layer

## 2.1 Blockchain Architecture (Base L2)
...
## 2.2 Protocol Economy (Native ETH)
...
## 2.3 Non-Custodial Wallet Integration
